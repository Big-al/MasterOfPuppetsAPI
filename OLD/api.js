...
const cors = require("cors"); // Cors allows cross platform scripting
// @ts-ignore
const passport_1 = __importDefault(require("./config/passport"));
const PuppetMaster = express(); // Express simply allows us to create port listeners
const port = 3000; // Access at http://localhost:3000
const ApiKey = 'e7ed118c-36bc-431a-a3b4-000b79655720'; // Not pretty but good enough for demo purposes
// ----------------- Init -----------------
// Connect to DB
